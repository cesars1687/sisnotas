...
class Alumno_model extends CI_Model
{
    ...
    function notas($nombre)
    {
        ...
        return $this->db->query('select cursos.cur_nombre,asignatura.asi_nombre,alumnos.alu_nombres,alumnos.alu_apellidos,alu_asi.alu_asi_nota from cursos,asignatura,alumnos,alu_asi,curso_abierto where (alumnos.alu_nombres ="' . $nombre . '"  or alumnos.alu_apellidos ="' . $nombre . '")
