<div class="well">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select name="curso" id="curso">
                    ...
                    <option value="<? echo $curso->idCurso_abierto;?>"><? echo $curso->cur_nombre;?></option>
                    <?  endforeach ?>
                </select>
            </div>
        </div>
    ...
    <table class="table">
        ...
        <?  $nom=$alumno->alu_nombres;
            if($nom_past==''||$nom!=$nom_past){?>
            <?if($nom_past!=''){?>
                <td><?php if($band!=0){ echo $notaf=$nota/$band;}?> </td>
                <td>
                    <? if($notaf>10.5){ echo "aprobado"; }else{ echo "desaprobad"; }
                    $nota=0;$band=0;
                    ?>
                </td>
                </tr>
        ...
        <?if(sizeof($alumnos)>0){?>
            ...
            <td>
                <? if($notaf>10.5){ echo "aprobado"; }else{ echo "desaprobado , debe llevarse en otro curso"; }
                $nota=0;$band=0;
                ?>
            </td>
                </tr>
